...
import 'package:nitoons/UI%20Actor/ui.dart';
...
import '../actor_lookalikes/actor_lookalikes.dart';
import '../link_to_reels/link_to_reels.dart';
import '../location/location_view.dart';
import 'edit_actor_profile_viewmodel.dart';

class EditActorProfile extends StatefulWidget {
  static String routeName = "/editActorProfile";
  const EditActorProfile({super.key});

  @override
  State<EditActorProfile> createState() => _EditActorProfileState();
}

class _EditActorProfileState extends State<EditActorProfile> {
  
  @override
  Widget build(BuildContext context) {
    return MVVM<EditActorProfileViewmodel>.builder(
      viewModel: locator<EditActorProfileViewmodel>(),
      disposeVM: false,
            ...
            child: SingleChildScrollView(
              ...
              Column(
                ...
                children: [
                  ...
                  buildProfileEditInfoTiles(viewModel),
                  SizedBox(
                    height: Spacings.spacing10.h,
                  ),
                  Row(
              ...
              onPressed: () {
                ...
                .push(MaterialPageRoute(builder: (context) => LinkToReels()));
              },
            ),
                    ],
                  ),
              ...
              onPressed: () {
                Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => ActorlookalikeScreen()));
              },
            ),
                    ],
                  ),
              ...
              onPressed: () {
                Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => LocationView()));
              },
            ),
                    ],
                  ),
                  ...
                  Text(
                    viewModel.getUserProfileModel?.data != null
                        ? '${viewModel.getUserProfileModel!.data!.state.toString()}'
                        : '',
                    style: Theme.of(context).textTheme.displaySmall!.copyWith(
                        fontWeight: FontWeight.w400, color: Color(0xff757575)),
                  ),
                  ...
                  Text(
                    viewModel.getUserProfileModel?.data != null
                        ? '${viewModel.getUserProfileModel!.data!.city.toString()}'
                        : '',
                    style: Theme.of(context).textTheme.displaySmall!.copyWith(
                        fontWeight: FontWeight.w400, color: Color(0xff757575)),
                  ),
              ...
              onPressed: () {
                Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => PreferredRoles()));
              },
            ),
                    ],
                  ),
              ...
              onPressed: () {
                Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) =>OtherSkills()));
              },
            ),
                    ],
                  ),
...
// Use the result inside the Text widget
  ...
  Widget buildProfileEditInfoTiles(EditActorProfileViewmodel viewModel) {
