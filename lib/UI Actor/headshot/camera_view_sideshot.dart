...
import 'headsideshot.dart';

class CameraViewSideshot extends StatefulWidget {
  const CameraViewSideshot({
    super.key,
  });

  @override
  State<CameraViewSideshot> createState() => _CameraViewSideshotState();
}

late CameraController controller;

class _CameraViewSideshotState extends State<CameraViewSideshot> {
  late CameraController controller;
                ...
                press: () async {
                  try {
                    ...
                    await Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => Headsideshot(
                          // Pass the automatically generated path to
                          // the DisplayPictureScreen widget.
                          imageSideshotPath: image.path,
                        ),
                      ),
                    );
                  } catch (e) {
