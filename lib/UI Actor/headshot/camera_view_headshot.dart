...
import 'headshot_view.dart';

class CameraViewHeadshot extends StatefulWidget {
  const CameraViewHeadshot({
    super.key,
  });

  @override
  State<CameraViewHeadshot> createState() => _CameraViewHeadshotState();
}

late CameraController controller;

class _CameraViewHeadshotState extends State<CameraViewHeadshot> {
  late CameraController controller;
