...
class HeadshotVm extends ViewModel{
  ...
  // Future<void> submitData(image) async {
  //   setLoadingState();
  //   try {
  ...
  //         Navigator.pushNamed(context, '/headsideshot');
...
Future<void> submitData(BuildContext context, image) async {
    setLoadingState();
       final homePagePath = await SharedPreferencesHelper.getUserHomePage();    
     final accessToken = await SecureStorageHelper.getAccessToken();
    try {
