...
class CameraSideshot extends StatefulWidget {
  const CameraSideshot({
    super.key,
  });

  @override
  State<CameraSideshot> createState() => _CameraSideshotState();
}

late CameraController controller;

class _CameraSideshotState extends State<CameraSideshot> {
  late CameraController controller;
