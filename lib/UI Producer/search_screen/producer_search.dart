...
import 'package:nitoons/UI%20Producer/search_screen/producer_search_vm.dart';
...
class ProducerSearch extends ConsumerWidget {
  ProducerSearch({super.key});
  ...
  Widget build(BuildContext context, ref) {
    final viewModel = ProducerSearchViewModel(ref);

    return Scaffold(
      appBar: AppBar(
        actions: [
          Padding(
              padding: EdgeInsets.only(right: 16.w, left: 0),
