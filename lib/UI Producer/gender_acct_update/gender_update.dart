...
import 'gender_update_viewmodel.dart';

class GenderUpdate extends StatelessWidget {
  static String routeName = "/genderUpdate";
  const GenderUpdate({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MVVM(
      view: () => _GenderUpdate(),
      viewModel: locator<GenderUpdateViewmodel>(),
      disposeVM: false,
    );
  }
}

class _GenderUpdate extends StatelessView<GenderUpdateViewmodel> {
  @override
