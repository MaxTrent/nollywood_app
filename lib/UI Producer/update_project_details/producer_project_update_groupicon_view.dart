...
class ProducerProjectUpdateGroupiconView extends StatefulWidget {
  static String routeName = "/producerProjectUpdateGroupiconView";

  const ProducerProjectUpdateGroupiconView({super.key});

  @override
  State<ProducerProjectUpdateGroupiconView> createState() =>
      _ProducerProjectUpdateGroupiconViewState();
}

class _ProducerProjectUpdateGroupiconViewState
    extends State<ProducerProjectUpdateGroupiconView> {
  @override
  Widget build(BuildContext context) {
    return MVVM<ProducerProjectUpdateViewmodel>.builder(
          ...
          floatingActionButton: Padding(
              ...
              child: Padding(
                ...
                child: MainButton(
                  ...
                  press: () {
              viewModel.updateProducerProject(context, viewModel.image!.path );
