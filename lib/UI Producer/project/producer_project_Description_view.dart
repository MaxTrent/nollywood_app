...
class ProducerProjectDescriptionPage extends StatelessWidget {
  static String routeName = "/producerProjectDescriptionPage";
  const ProducerProjectDescriptionPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MVVM(
      view: () => _ProducerProjectDescriptionPage(),
...
class _ProducerProjectDescriptionPage
    extends StatelessView<ProducerProjectViewmodel> {
  @override
