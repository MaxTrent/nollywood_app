...
import 'age_update_viewmodel.dart';

class AgeUpdate extends StatelessWidget {
  static String routeName = "/ageUpdate";
  ...
  Widget build(BuildContext context) {
    return MVVM(
      view: () => _AgeUpdate(),
      viewModel: locator<AgeUpdateViewmodel>(),
      disposeVM: false,
    );
  }
}

class _AgeUpdate extends StatelessView<AgeUpdateViewmodel> {
  @override
