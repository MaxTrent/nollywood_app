...
class ProducerCreateMonologueRolesPage extends StatelessWidget {
  static String routeName = "/producerCreateMonologueRolesPage";

  const ProducerCreateMonologueRolesPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MVVM(
      view: () => _ProducerCreateMonologueRolesPage(),
...
class _ProducerCreateMonologueRolesPage
            ...
            child: Padding(
              ...
              child: BaseText(
                ...
                onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => ProducerAddMonologuesToRole())),
              ),
            ),
          )
        ],
            ...
            children: [
              ...
              MainButton(
                ...
                press:viewModel.isButtonActive? () {
                  viewModel.CreateSingleMonologue();
                }:null,
              ),
              SizedBox(
