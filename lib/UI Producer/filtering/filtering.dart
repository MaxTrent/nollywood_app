...
import 'filtering_vm.dart';


class Filtering extends ConsumerWidget {
  Filtering({super.key});
  ...
  Widget build(BuildContext context, ref) {
    final viewModel = FilteringViewModel(ref);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text.rich(
                 TextSpan( text: 'Currently filtering for: ',
                  style: Theme.of(context)
                      .textTheme
                      .displaySmall!
                      .copyWith(fontWeight: FontWeight.w400),
                 children: [
                     TextSpan( text: 'Adaeze Johnson',
                     style: Theme.of(context)
                         .textTheme
                         .displayMedium!
                         .copyWith(fontWeight: FontWeight.w700, color: selectColor),)
  ...
  Row buildGenderSelection(FilteringViewModel viewModel) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        GestureDetector(
